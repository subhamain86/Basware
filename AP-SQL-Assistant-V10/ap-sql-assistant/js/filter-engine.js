(function (root) {
  ...
  var OPERATORS = [
    ...
    { id: 'between', label: 'Between', arity: 2 }, { id: 'is_null', label: 'Is NULL', arity: 0 },
    { id: 'is_not_null', label: 'Is not NULL', arity: 0 }, { id: 'is_empty', label: 'Is empty', arity: 0 }, { id: 'is_not_empty', label: 'Is not empty', arity: 0 }
  ];
  ...
  var API = { OPERATORS: OPERATORS, getOperator: getOperator, buildConditionSql: buildConditionSql, buildWhereSql: buildWhereSql, newCondition: newCondition, duplicateCondition: duplicateCondition, sqlLiteral: sqlLiteral };
